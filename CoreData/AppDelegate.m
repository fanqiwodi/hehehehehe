...
//    
//    view.managerContext = [self managedObjectContext];
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "uics.CoreData" in the application's documents directory.
